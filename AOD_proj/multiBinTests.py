...
class BinPackingTest2(unittest.TestCase):

    def test_1(self):
        weight = [1, 2, 2]
        bincapicities = [2, 1]

        usedBins = binPacking.binPackingMulti(weight, bincapicities)

        self.assertEqual(3, usedBins[0] + usedBins[1])

    def test_2(self):
        weight = [2, 2, 2, 2, 2, 2]
        bincapicities = [4, 2]

        usedBins = binPacking.binPackingMulti(weight, bincapicities, True)
